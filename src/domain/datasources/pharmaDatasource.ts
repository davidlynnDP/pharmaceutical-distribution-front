import { CreateClientParams, UpdateClientParams, PaginationParams, CreateSupplierParams, UpdateSupplierParams, CreateSaleParams, CreateSaleQuery, CreateProductQuery, CreateProductParams, UpdateProductParams, UpdateProductQuery } from "../interfaces";
import { Client, Product, Sale, Supplier } from "../models"



export interface PharmaDataSource {
